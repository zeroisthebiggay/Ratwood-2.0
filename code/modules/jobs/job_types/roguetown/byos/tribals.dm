/datum/job/roguetown/tribalguard
	...
	allowed_maps = list("Build Your Own Settlement")
	...
	job_subclasses = list(
		...
		/datum/advclass/tribalguard/forester
	)
...
/datum/outfit/job/roguetown/tribalguard/ranger/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/advclass/tribalguard/forester
	name = "Forester"
	tutorial = "TRIBALTRIBAL!."
	outfit = /datum/outfit/job/roguetown/tribalguard/forester
...
/datum/outfit/job/roguetown/tribalguard/forester/pre_equip(mob/living/carbon/human/H)
	..()
